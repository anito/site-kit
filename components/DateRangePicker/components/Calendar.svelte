<script>
  ...
  import Controls from "@sveltejs/site-kit/components/DateRangePicker/components/Controls.svelte"
  import DaysOfWeek from "@sveltejs/site-kit/components/DateRangePicker/components/DaysOfWeek.svelte"
  import Week from "@sveltejs/site-kit/components/DateRangePicker/components/Week.svelte"
  import { getCalendarWeeks, getTouchTarget } from "@sveltejs/site-kit/components/DateRangePicker/utils"
